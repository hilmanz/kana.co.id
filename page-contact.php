...
if (isset($_POST['sendCV'])=="sendCV") { 
	$email_to = "info@kana.co.id,amien.krisna@kana.co.id,vera@kana.co.id,bayu.ekaputra@kana.co.id,narendra.wicaksana@kana.co.id,agnes.adellina@kana.co.id,ridwan@sonar.id";
	//$email_to = "deddy@kana.co.id,dedysumarna@gmail.com";
$email_to = "mridwana@gmail.com";
